...
go 
alter table zpatch20181120_sys_usergroup_permission 
  add CONSTRAINT fk_zpatch20181120_sys_usergroup_permission_parent 
...
alter table sys_usergroup_permission drop constraint PK__sys_user__530D6FE408012052 
alter table sys_usergroup_permission alter column objid varchar(100) not null 
alter table sys_usergroup_permission add constraint pk_sys_usergroup_permission primary key (objid)
go 


alter table sys_usergroup_member drop constraint FK__sys_userg__secur__3EE740E8
go 
alter table sys_securitygroup drop constraint PK__sys_secu__530D6FE46E414E4F
alter table sys_securitygroup alter column objid varchar(100) not null 
alter table sys_securitygroup add constraint pk_sys_securitygroup primary key (objid)
go 
...
go 
create index ix_securitygroup_objid on sys_usergroup_member (securitygroup_objid) 
go 
alter table sys_usergroup_member 
  add constraint fk_sys_usergroup_member 
...
drop table zpatch20181120_sys_usergroup_permission
go 
drop table zpatch20181120_sys_usergroup
go 
